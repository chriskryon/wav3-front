    ...
    return (
      <div className="relative flex flex-col items-center justify-center min-h-[340px] p-0 mt-10">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="w-full h-full bg-gradient-to-br from-[#e0f7fa]/70 via-[#b2ebf2]/60 to-[#00109b]/40 blur-xl" />
        </div>
        <div className="relative w-full max-w-md mx-auto z-10">
          <div className="absolute -top-10 left-1/2 -translate-x-1/2 z-20">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#00109b] to-[#17818a] flex items-center justify-center shadow-2xl border-4 border-white">
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-[#00109b]/20 pt-16 pb-10 px-8 flex flex-col items-center animate-fade-in-up">
            ...
            <p className="mb-7 text-base text-[#17818a] font-normal max-w-md mx-auto leading-relaxed text-center">
              ...
              <br />
              <span className="block mt-3 text-[#00109b] font-semibold text-lg">
                Enjoy the full experience by verifying your identity!
              </span>
            </p>
            <Button
              onClick={() => router.push('/profile')}
              className="bg-gradient-to-r from-[#00109b] to-[#17818a] hover:scale-105 hover:shadow-xl text-white font-bold px-10 py-4 rounded-2xl shadow-lg transition-all duration-200 text-base tracking-wide focus:outline-none focus:ring-2 focus:ring-[#00109b]/40"
              size="lg"
            >
              Complete KYC Now
            </Button>
