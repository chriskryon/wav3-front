          ...
          <div className="flex-1 flex flex-col gap-1 items-start">
            <div className="font-extrabold text-lg text-main leading-tight tracking-tight flex items-center gap-2">
              ...
              >
                ...
                <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="#1ea3ab"><rect x="7" y="7" width="10" height="10" rx="2" strokeWidth="2"/><rect x="3" y="3" width="10" height="10" rx="2" strokeWidth="2"/></svg>
              </button>
            </div>
