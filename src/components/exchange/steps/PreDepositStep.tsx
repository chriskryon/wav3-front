  ...
  return (
    <div className="flex flex-col gap-4 h-full p-2 bg-white rounded-xl border border-gray-200 overflow-y-auto">
      ...
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-[#00109b]/10 mb-1">
          <svg className="w-4 h-4 text-[#00109b]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="inline-flex items-center gap-1 bg-gray-50 text-gray-700 px-3 py-1 rounded-lg mt-3 border border-gray-200">
          <div className="w-1.5 h-1.5 bg-[#00109b] rounded-full"></div>
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="flex flex-col items-center gap-1">
              <div className="w-8 h-8 rounded-lg bg-[#00109b] flex items-center justify-center shadow-sm">
      ...
      <div className="flex gap-2 mt-auto pt-3">
        ...
        <Button
          ...
          className="flex-1 bg-[#00109b] text-white py-2 px-4 rounded-lg border border-[#00109b] hover:bg-[#188a91] transition-colors font-medium"
        >
