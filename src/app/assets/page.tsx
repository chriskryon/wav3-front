...
import { RefreshCw, Search, TrendingDown, TrendingUp, Filter } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="muted-text text-lg">Manage your crypto and fiat assets</p>
          </div>
        ...
        <Card className="glass-card-enhanced mb-8">
          <CardContent className="p-6">
            <div className="flex gap-4">
              ...
              <Button variant="outline" className="glass-button h-12 px-6 bg-transparent">
                  ...
                  <Card key={index} className="glass-card-enhanced glass-hover cursor-pointer h-fit">
                    <CardHeader className="pb-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <CardTitle className="text-lg font-bold text-main">{asset.name}</CardTitle>
                            <p className="text-sm muted-text">{asset.symbol}</p>
                          </div>
                        </div>
                        <Badge
                          className={`glass-badge ${
                            asset.type === "Crypto" ? "text-primary border-primary/30" : "text-main border-main/30"
                          }`}
                        >
                          {asset.type}
                        </Badge>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold text-main">${asset.value.toLocaleString()}</span>
                      </div>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm font-medium text-main">{asset.network}</span>
                      </div>
                    </CardContent>
                  </Card>
                ))}
                  ...
                  .map((asset, index) => (
                    <Card key={index} className="glass-card-enhanced glass-hover cursor-pointer h-fit">
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex justify-between">
                          <span className="muted-text">Balance:</span>
                          <span className="font-bold text-main">${asset.balance.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between">
